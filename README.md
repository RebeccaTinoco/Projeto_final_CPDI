...
## Habilidades trabalhadas no curso

Ao construir este projeto final, foram praticadas principalmente:
...
- Menu de navegação responsivo com versão desktop e menu hamburguer para dispositivos móveis.
- Seção Início com mensagem principal da marca e botão de rolagem para explorar a página.
- Seção Sobre explicando:
  - A proposta da ReVeste como marca de moda sustentável.
  - O alinhamento com Objetivos de Desenvolvimento Sustentável (ODS 5, 8, 12 e 13).
- Seção Serviços com carrossel em JavaScript apresentando:
  - Venda de roupas sustentáveis.
  - Oficinas de conserto e customização.
  - Programa de troca de peças usadas.
